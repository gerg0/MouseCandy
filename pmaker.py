...
def make_project():
	...
	if fvalues.ptype == "gng":
		...
		if fvalues.stim_type == "visual":
			p = mclass.VisualGng(fvalues.name, fvalues.notes, fvalues.video, \
					fvalues.action_count, fvalues.positive_count, fvalues.grace_preiod, fvalues.active_period, fvalues.idle_period, fvalues.extra_time, fvalues.reset_on_random,\
					fvalues.positive_animation, fvalues.negative_animation, fvalues.line_width, fvalues.line_speed, fvalues.stim_length)
	...
	if fvalues.ptype == "pav":
		...
		if fvalues.stim_type == "visual":
			p = mclass.VisualPav(fvalues.name, fvalues.notes, fvalues.video, \
					fvalues.action_count, fvalues.wait_time_min, fvalues.wait_time_max,	 \
					fvalues.animation_angle, fvalues.line_width, fvalues.line_speed, fvalues.stim_length)
